...
function(t) {
    ...
    function e(e) {
        return this.each(function() {
            ...
            o = t.extend({},
            r.DEFAULTS, i.data(), "object" == typeof e && e);
    ...
    var i = function() {
        for (var t, e = 3,
        i = document.createElement("div"), n = i.getElementsByTagName("i"); i.innerHTML = "<!--[if gt IE " + ++e + "]><i></i><![endif]-->", n[0];);
        return e > 4 ? e: t
    } (),
    n = function() {
    ...
    r.prototype.generateBlurredImage = function(t) {
        ...
        this.internalID = n(),
        e.length > 0 && (this.options.duration && this.options.duration > 0 ? this.useVelocity ? e.first().velocity({
            opacity: 0
        },
        {
            duration: this.options.duration,
        ...
        this.$blurredImage = i ? this.createIMG(t, this.$width, this.$height) : this.createSVG(t, this.$width, this.$height)
    },
